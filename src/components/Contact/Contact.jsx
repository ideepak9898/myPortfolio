...
const Contact = () => {
    ...
    return(
        <Container style={{paddingTop: '50px'}} >
            ...
            <h1 >Get in Touch</h1>
            <h1 className="boldColor">Contact me</h1>
            </Col>
            <Col md={6} className="c-right">
                ...
                <span className='done'>{done && "Thank you for contacting me. I appreciate you taking the time to reach out and will get back to you as soon as possible."}</span>
                </form>
            </Col>
            </Row>
        </Container>
